...
class RunSettings:
    ...
    search_gpu: bool = DefaultVal(True)
...
class IndexingSettings:
    ...
    n_centroid_f: str = 'lambda n_vec: int(2 ** np.floor(np.log2(16 * np.sqrt(n_vec))))'

    sample_pid_f: str = 'lambda typical_doclen, num_passages: 16 * np.sqrt(typical_doclen * num_passages)'
